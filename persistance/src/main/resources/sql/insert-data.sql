INSERT INTO
  students
  (name, surname, age, email, specialisation)
VALUES
  ('Monika', 'Wojtanowska', 19, 'monika_wojt@gmail.com', 'English literature'),
   ('Mateusz', 'Kozlowsky', 20, 'kozlowsky_mateusz@gmail.com', 'Math analysis'),
         ('Anna', 'Lis', 20, 'anna_lis@gmail.com', 'Chemical technology');

INSERT INTO
  teachers
  (name, surname, age, email, subject)
VALUES
  ('Monika', 'Green', 35, 'monika_gre@gmail.com', 'Chemistry'),
